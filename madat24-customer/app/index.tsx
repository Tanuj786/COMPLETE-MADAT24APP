    ...
    <Animated.View style={{ opacity: op, transform: [{ scale: sc }], alignItems: "center", marginBottom: 28 }}>
      ...
      <Animated.View style={{ opacity: textOp, alignItems: "center", marginTop: 10 }}>
        ...
        <Text style={{ color: GREY2, fontFamily: FONTS.regular, fontSize: 12, marginTop: 8, textAlign: "center", lineHeight: 19 }}>
          India's most advanced on-demand{"\n"}mechanic dispatch system
        </Text>
      </Animated.View>
    </Animated.View>
  );
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        <View style={{ paddingTop: 60, paddingHorizontal: 24, alignItems: "center" }}>
          ...
          <Animated.View style={{ opacity: heroOp, flexDirection: "row", gap: 10, marginBottom: 32 }}>
            <StatPill value="15K+" label="Technicians" delay={900}  />
            <StatPill value="50K+" label="Services"    delay={1050} />
            <StatPill value="<8min" label="Response" highlight delay={1200} />
          </Animated.View>

          {/* CTAs */}
          <View style={{ width: "100%", gap: 12 }}>
            <HeroBtn onPress={() => router.push("/(auth)/customer-login")} primary
              icon="⚡" title="Emergency Dispatch" sub="Get a mechanic in minutes" delay={1000} />
            <HeroBtn onPress={() => router.push("/(auth)/customer-signup")}
              icon="📱" title="Create Account" sub="Sign up in 30 seconds" delay={1150} />
          </View>
        </View>
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 44 }}>
          ...
          {[
            { n: "01", icon: "📍", title: "Share Location",      desc: "GPS pinpoints you instantly. No typing needed.",         color: ORANGE },
            { n: "02", icon: "⚡", title: "Mechanic Dispatched", desc: "Nearest verified tech accepts in under 2 minutes.",      color: BLUE   },
            { n: "03", icon: "✅", title: "Problem Solved",      desc: "Pay after service. Rate your mechanic. Simple.",         color: WHITE  },
          ].map((s, i) => (
            <View key={i} style={{
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 40 }}>
          ...
          >
            ...
            <Text style={{ color: GREY1, fontFamily: FONTS.regular, fontSize: 13.5, textAlign: "center", lineHeight: 21, marginBottom: 24 }}>
              {"Join 50,000+ drivers who trust\nMadat24 across India"}
            </Text>
            <Pressable
            ...
            >
              <LinearGradient colors={[ORANGE, ORANGE2]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ paddingVertical: 18, alignItems: "center" }}>
                <Text style={{ color: WHITE, fontFamily: FONTS.black, fontSize: 17 }}>⚡  Get Started — It's Free</Text>
              </LinearGradient>
            </Pressable>
          </LinearGradient>
        </View>
